    ...
    <>
      <div className="w-full rounded border-[0.5px] p-4 shadow">
        <div className="mb-8 flex justify-between">
          <h6 className="text-xs font-bold">Active Placements</h6>
          <Link
            href="/department"
      ...
      <div className="w-full rounded border-[0.5px] p-4 shadow">
        <div className="mb-8 flex justify-between">
          <h6 className="text-xs font-bold">Inactive Placements</h6>
      ...
      <div className="w-full rounded border-[0.5px] p-4 shadow">
        <div className="mb-8 flex justify-between">
          <h6 className="text-xs font-bold">All Placements</h6>
          <Link href="/department" className="rounded-md bg-[#50c9f4] px-2 py-1 text-xs text-[#000000]">
            View
          </Link>
        </div>
