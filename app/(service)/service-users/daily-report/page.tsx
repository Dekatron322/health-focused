...
export default function NewLogs() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!serviceUserId) throw new Error("Service User ID not found in localStorage.")
      ...
      if (!response.ok) {
        throw new Error("Failed to submit the daily log. Please try again.")
      }
      ...
      alert(error.message || "An error occurred while submitting the daily log.")
    } finally {
      setLoading(false)
    }
  }
